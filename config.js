exports.createPasswordResetEmail = ({ token, requestUrl }) => {
                  ...
                  <tr>
                    <td align="center" valign="top" style="padding: 36px 24px;">
                      <a href="https://sendgrid.com" target="_blank" style="display: inline-block;">
                        <img src="https://i.imgur.com/bwgBegu.png" alt="Logo" border="0" width="480" style="display: block; width: 480px; max-width: 480px; min-width: 480px;">
                      </a>
                    </td>
                  </tr>
                </table>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                  ...
                  <tr>
                    <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                      <p style="margin: 0;">You received this email because we received a request for https://edmspot.net for your account. If you didn't request a password reset you can safely delete this email.</p>
                    </td>
                  </tr>
                  <!-- end permission -->
